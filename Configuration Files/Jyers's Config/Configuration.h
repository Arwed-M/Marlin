 ...
 * 350°C Thermistor - beta 3950 66 : 4.7MΩ  Dyze Design High Temperature
 * Thermistor 67 : 500kΩ  SliceEngineering 450°C Thermistor 70 : 100kΩ  bq
...
// homed. Also enable HOME_AFTER_DEACTIVATE for extra safety.
#define HOME_AFTER_DEACTIVATE // Require rehoming after steppers are
                              // deactivated. Also enable
...
#define FIL_RUNOUT_ENABLED_DEFAULT                                             \
  false // Enable the sensor on startup. Override with M412 followed by M500.
...
#define NOZZLE_PARK_Z_RAISE_MIN                                                \
  5 // (mm) Always raise Z by at least this distance
...
// #define TOUCH_IDLE_SLEEP 300 // (secs) Turn off the TFT backlight if set
// (5mn)
...
#define NEOPIXEL_TYPE                                                          \
  NEO_GRB // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in
          // Adafruit_NeoPixel.h)
#define NEOPIXEL_PIN PB2 // LED driving pin
// #define NEOPIXEL2_TYPE NEOPIXEL_TYPE
// #define NEOPIXEL2_PIN    5
#define NEOPIXEL_PIXELS                                                        \
  4 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is
    // disabled.)
