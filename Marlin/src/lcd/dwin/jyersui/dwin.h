...
// Keep the corner-level leveling icons available to the JyersUI menu.
...
#define ICON_Mesh   ICON_Axis
#define ICON_Brightness ICON_Axis
#define ICON_ResetEEPROM ICON_ReadEEPROM
